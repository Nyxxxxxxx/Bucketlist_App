...
// 이 부분은 받아서 저장하는 형식으로 해야 할 것 같다.
let productSamples = [
    Product(name: "First Mission", imageName: "fig", price: "24.06.11", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do"),
